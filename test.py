"""
Grounded QA API with Citations and Confidence
-----------------------------------------------
This API answers questions ONLY using the text chunks provided in the request.
It never uses outside knowledge. If the answer isn't clearly present in the
chunks, it returns "I don't know" with low confidence.
